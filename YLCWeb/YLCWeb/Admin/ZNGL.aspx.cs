...
{
    public partial class ZNGL : System.Web.UI.Page
    {
            ...
            if (!IsPostBack) {
                if (Request.QueryString["id"] != null && Request.QueryString["id"].ToString() != "") {
                    try
                    {
                        ...
                        DataTable dt = dbHelper.ExecuteDataTable("","select * from T_ZNGL where id = @id",new SqlParameter[]{
        ...
        {
            DataBaseHelper dbHelper = new DataBaseHelper(ConfigurationManager.ConnectionStrings["DB"].ToString());
            dbHelper.ExecuteNonQuery("update T_ZNGL set demo = @demo where id=@id", new SqlParameter[]{
