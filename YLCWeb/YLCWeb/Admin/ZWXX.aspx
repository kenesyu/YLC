<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ZWXX.aspx.cs" Inherits="YLCWeb.Admin.ZWXX" %>
                                  ...
                                  <div class="panel-body">
                                      <div class="form">
                                         <div class="form-group">
                                              <label class="col-sm-2 control-label col-sm-2">类型</label>
                                              <div class="col-sm-10">
                                                  <asp:DropDownList class="form-control" ID="selType" style="color:Black" runat="server">
                                                    <asp:ListItem Text="景区要闻" Value="景区要闻"></asp:ListItem>
                                                    <asp:ListItem Text="招标公告" Value="招标公告"></asp:ListItem>
                                                    <asp:ListItem Text="工作简报" Value="工作简报"></asp:ListItem>
                                                    <asp:ListItem Text="政务动态" Value="政务动态"></asp:ListItem>
                                                  </asp:DropDownList>
                                              </div>
                                              </div>
                                         <div class="form-group">
                                              <label class="col-sm-2 control-label col-sm-2">标题</label>
                                              <div class="col-sm-10">
